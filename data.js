...
const ramos = [
  ...
  { id: 2, sigla: "HAC100", nombre: "Comunicación Escrita", semestre: 1, area: "humanidades", creditos: 3, prerrequisitos: [] },
  ...
  { id: 9, sigla: "HAA102", nombre: "Comunicación Oral", semestre: 2, area: "humanidades", creditos: 3, prerrequisitos: ["HAC100"] },
  ...
  { id: 16, sigla: "MATE25", nombre: "Cálculo Diferencial", semestre: 3, area: "matematica", creditos: 6, prerrequisitos: ["MATE11", "MATE20"] },
  { id: 17, sigla: "HCW102", nombre: "Inglés III", semestre: 3, area: "idiomas", creditos: 3, prerrequisitos: ["HCW101"] },
  { id: 18, sigla: "ICS112", nombre: "Legislación Empresarial", semestre: 3, area: "legal", creditos: 4, prerrequisitos: ["ICS111"] },
  ...
  { id: 20, sigla: "IDP107", nombre: "Taller de Creatividad", semestre: 3, area: "talleres", creditos: 4, prerrequisitos: ["MATE10", "HAC100"] },
  ...
  { id: 22, sigla: "DEWO", nombre: "Deportes", semestre: 4, area: "deportes", creditos: 2, prerrequisitos: ["EFI101"] },
  ...
  { id: 25, sigla: "IQA161", nombre: "Introducción a la Ingeniería Sostenible", semestre: 4, area: "sustentabilidad", creditos: 4, prerrequisitos: ["ICS161"] },
  { id: 26, sigla: "ICS162", nombre: "Microeconomía I", semestre: 4, area: "economia", creditos: 5, prerrequisitos: ["ICS161", "MATE25"] },
  { id: 27, sigla: "IDP108", nombre: "Taller de Pensamiento de Diseño", semestre: 4, area: "talleres", creditos: 4, prerrequisitos: ["IDP107"] },
  ...
  { id: 29, sigla: "HAH101", nombre: "Historia Económica", semestre: 5, area: "humanidades", creditos: 3, prerrequisitos: [] },
  ...
  // -------------------------------------
  { id: 35, sigla: "ICS294", nombre: "Econometría", semestre: 6, area: "economia", creditos: 5, prerrequisitos: ["MATE034"] },
  ...
  { id: 43, sigla: "ICS315", nombre: "Entorno Legal de la Empresa", semestre: 7, area: "legal", creditos: 4, prerrequisitos: ["ICS214", "ICS244"] },
  { id: 44, sigla: "ICS164", nombre: "Evaluación Privada y Social de Proyectos", semestre: 7, area: "finanzas", creditos: 5, prerrequisitos: ["ICS142", "INF303"] },
  ...
  { id: 48, sigla: "ICS223", nombre: "Dirección Estratégica II", semestre: 8, area: "administracion", creditos: 5, prerrequisitos: ["ICS22126"] },
  ...
  { id: 51, sigla: "ICS233", nombre: "Marketing II", semestre: 8, area: "marketing", creditos: 5, prerrequisitos: ["ICS70825", "MATE034"] },
  { id: 52, sigla: "ICS166", nombre: "Preparación y Presentación de Proyectos", semestre: 8, area: "finanzas", creditos: 4, prerrequisitos: [] },

  // -------------------------------------
  // 9no Semestre (4 ramos)
  // -------------------------------------
  { id: 53, sigla: "ICS801", nombre: "Electivo I", semestre: 9, area: "electivo", creditos: 4, prerrequisitos: [] },
  { id: 54, sigla: "ICS802", nombre: "Electivo II", semestre: 9, area: "electivo", creditos: 4, prerrequisitos: [] },
  { id: 55, sigla: "ICS700", nombre: "Optativo de Profundización I", semestre: 9, area: "optativo", creditos: 5, prerrequisitos: [] },
  { id: 56, sigla: "ICS701", nombre: "Optativo de Profundización II", semestre: 9, area: "optativo", creditos: 5, prerrequisitos: [] },

  // -------------------------------------
  // 10mo Semestre (2 ramos)
  // -------------------------------------
  { id: 57, sigla: "ICS803", nombre: "Electivo III", semestre: 10, area: "electivo", creditos: 4, prerrequisitos: [] },
  { id: 58, sigla: "ICS399", nombre: "Seminario de Título", semestre: 10, area: "titulacion", creditos: 12, prerrequisitos: ["ICS701"] }
];
